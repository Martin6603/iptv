...
| --- | --- | --- |
| **Best** | One stream per channel, best first | `https://Martin6603.github.io/iptv/playlists/best.m3u` |
| **Working only** | Only streams that passed the last health check | `https://Martin6603.github.io/iptv/playlists/online.m3u` |
| **Everything** | Every stream, including backups | `https://Martin6603.github.io/iptv/playlists/index.m3u` |
| **EPG** | Programme guide for every linked channel | `https://Martin6603.github.io/iptv/epg/guide.xml.gz` |
